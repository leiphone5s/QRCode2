...
import widget.BaseWheelView2;

public class RegisterSelectWheel2 extends BaseWheelView2 implements View.OnClickListener, OnWheelChangedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.registerselectwheel2);
        setUpViews();
        setUpListener();
        setUpData();
    }
    ...
    private void setUpViews() {
        mViewFaculty = findViewById(R.id.id_faculty);
        mViewDepart = findViewById(R.id.id_depart);
    ...
    private void setUpData() {
        initFacultyDatas();
        mViewFaculty.setViewAdapter(new ArrayWheelAdapter<String>(RegisterSelectWheel2.this, mFacultyDatas));
        // 设置可见条目数量
