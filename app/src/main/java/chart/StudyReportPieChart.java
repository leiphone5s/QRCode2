...
//        float masterKnowledgeCount = DS.toFloat(report.getMasterKnowledgeCount());
        ...
        entries.add(new PieEntry(knowKnowledgeCount, "已签到"));
        entries.add(new PieEntry(weakKnowledgeCount, "未签到"));

        ArrayList<Integer> colors = new ArrayList<Integer>();
        colors.add(Color.parseColor("#ee5759"));//掌握
        colors.add(Color.parseColor("#49484A"));//了解
